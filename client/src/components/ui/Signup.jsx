      ...
      <div className="w-1/2 flex items-center justify-center bg-white p-8">
        <div className="w-full max-w-sm">
          ...
          <form>
            ...
            <div className="mb-4">
              <label htmlFor="phone" className="block text-sm font-medium text-gray-500 mb-1 font-zen">Phone</label>
              <input
                type="number"
                id="phone"
                name="phone"
            ...
            <div className="mb-4">
              <label htmlFor="city" className="block text-sm font-medium text-gray-500 mb-1 font-zen">City</label>
              <input
                type="text"
                id="city"
                name="city"
            ...
            <div className="mb-4">
              <label htmlFor="zipcode" className="block text-sm font-medium text-gray-500 mb-1 font-zen">Zip Code</label>
              <input
                type="number"
                id="zipcode"
                name="zipcode"
          ...
          <div className="flex flex-col items-center">
            <p className="text-sm text-gray mb-4 font-zen"> Already has account?<Link to="/login" className='font-semibold font-zen'> Sign in</Link></p>
